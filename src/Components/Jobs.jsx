...
const Jobs = () => {
  return (
    <div className="jobsType-Container flex flex-wrap gap-10 justify-evenly items-center rounded-[10px] py-10 mt-10">
      {Data.map(({ id, title, jobType, description, location, time, company }) => (
        <div key={id} className="jobType-container-child bg-slate-50 group group/item w-[250px] p-[20px] hover:bg-blue-500 hover:text-white shadow-lg shadow-greyIsh-400/700 hover:shadow-lg rounded-[10px]">
